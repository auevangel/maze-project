...
function Maze(cols, rows, cellSize) {
  ...
  this.hasUnvisitedNeighbor = function (cell) {
    return cell.col !== 0 && !this.cells[cell.col - 1][cell.row].visited || cell.col !== this.cols - 1 && !this.cells[cell.col + 1][cell.row].visited || cell.row !== 0 && !this.cells[cell.col][cell.row - 1].visited || cell.row !== this.rows - 1 && !this.cells[cell.col][cell.row + 1].visited;
  };
  /*redraw maze*/
...
var claphands = function claphands() {
  var clap = new Audio('./assets/audio/applause2.mp3');
